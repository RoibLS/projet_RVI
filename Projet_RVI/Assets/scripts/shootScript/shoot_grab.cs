...
public class shoot_grab : XRBaseInteractable
{
    ...
    void Update()
    {
        ...
        bool triggerValue;
        if (leftHandDevices[0].TryGetFeatureValue(UnityEngine.XR.CommonUsages.primary2DAxisClick,out triggerValue) && triggerValue && Time.time >= nextTimeToFire)
        {
