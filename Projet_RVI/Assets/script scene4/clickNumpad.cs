...
public class clickNumpad : XRBaseInteractable
{
    public int num;
    ...
    {
        if(password.cpt == 0){
            lum1.GetComponent<Renderer>().material = mato;
        }else if(password.cpt == 1){
            lum2.GetComponent<Renderer>().material = mato;
        }else if(password.cpt == 2){
            lum3.GetComponent<Renderer>().material = mato;
        }else if(password.cpt == 3){
            lum4.GetComponent<Renderer>().material = mato;
        }
        password.clicked(num);
